...
var button = [{ buttonId: '!text_grup', buttonText: { displayText: 'Good Bye👋'}, type: 1 }]
...
var button = [{ buttonId: '!text_grup', buttonText: { displayText: 'Welcome Kak👋'}, type: 1 }]
await conn.sendMessage(
update.id, 
{ 
text: `*Hello @${num.split("@")[0]}*\n*Welcome to ${metadata.subject}* \n\n*Jangan Lupa Intro*\n*Nama:*\n*Umur:*\n*Hobi:*\n*Askot:*\n\n*Jangan Rusuh Di Grup Ya Kak 🙏*`,
buttons: button, 
footer: metadata.subject,
mentions: [num] })
}
